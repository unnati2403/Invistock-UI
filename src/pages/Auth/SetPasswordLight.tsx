        ...
        <div className="max-w-md w-full relative">
          <div className="bg-white rounded-2xl shadow-2xl shadow-slate-200/50 border border-slate-200 p-8">
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 bg-gradient-to-br from-red-500 to-red-600 rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-red-500/30">
                <XCircle className="w-12 h-12 text-white" />
              </div>
              <h2 className="text-3xl font-bold text-slate-800 mb-3">Invalid Link</h2>
              ...
              <Button onClick={() => navigate('/login')} className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold h-12 rounded-xl shadow-lg shadow-blue-500/30">
                Go to Login
              </Button>
            </div>
          </div>
        ...
        <div className="max-w-md w-full relative">
          <div className="bg-white rounded-2xl shadow-2xl shadow-slate-200/50 border border-slate-200 p-8">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-3xl font-bold text-slate-800 mb-3">Password Set Successfully!</h2>
      ...
      <div className="max-w-7xl w-full relative grid lg:grid-cols-2 gap-8 items-center">
        <div className="bg-white rounded-3xl shadow-2xl shadow-slate-200/50 border border-slate-200 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-[length:200%_100%] px-10 py-8">
            ...
            <p className="text-blue-100 text-lg">Set up your secure admin account</p>
          </div>
        ...
        <div className="hidden lg:block space-y-6">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-xl shadow-slate-200/50 transform hover:scale-105 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Lightning Fast</h3>
            <p className="text-slate-600 text-base leading-relaxed">
          ...
          <div className="bg-white rounded-3xl border border-slate-200 p-8 shadow-xl shadow-slate-200/50 transform hover:scale-105 transition-transform duration-300">
            ...
            <h3 className="text-2xl font-bold text-slate-800 mb-3">Trusted Globally</h3>
            <p className="text-slate-600 text-base leading-relaxed">
