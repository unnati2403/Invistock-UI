import { ClipboardCheck, Info, Layers } from "lucide-react";
import type { ItemGroupStepProps } from "../CreateItemGroupWizard";

export default function ReviewStep({ formData }: ItemGroupStepProps) {
  const sections = [
    {
      ...
      fields: [
        ...
        { label: "Group Name", value: formData.name },
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-slate-500">
            Double-check your item group details before creating.
          </p>
        </div>
      </div>
                ...
                <div className="flex flex-wrap gap-4">
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm text-slate-700 font-medium">
                      {formData.attributes.length} attribute(s)
                    </span>
                  </div>
                  <div className="flex flex-col">
                    ...
                    <span className="text-sm text-slate-700 font-medium">
                      {formData.variants.length} variant(s) generated
                    </span>
                  </div>
                </div>
